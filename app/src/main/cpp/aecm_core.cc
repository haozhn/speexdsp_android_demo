...
int WebRtcAecm_ProcessFrame(AecmCore* aecm,
                            ...
                            int16_t* out) {
    // farend:1, nearendNoisy:1, nearendClean:0, out:1
//    __android_log_print(ANDROID_LOG_ERROR, "haozhinan", "farend:%d, nearendNoisy:%d, nearendClean:%d, out:%d",
//            farend == nullptr ? 0 : 1, nearendNoisy == nullptr ? 0 : 1, nearendClean == nullptr ? 0 : 1, out == nullptr ? 0 : 1);
